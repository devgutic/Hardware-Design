...
|---------|----------|-------| ----------|-------| ----------|-------|
| 1. Introducción al Diseño Digital | [**T1**](Talleres/T1.pdf)  | Pendiente | Pre.LAB1<br>[**LAB-1-Introduccion-al-Diseño-Digital**](Laboratorios/Lab-1-Introduccion.pdf) | Pendiente | Pendiente | Pendiente |
